import {
  NoSsr,
  Popper
} from "./chunk-4WZFX6LR.js";
import "./chunk-ILDHKE7F.js";
import {
  Typography_default
} from "./chunk-VJLQHVFF.js";
import {
  CartesianContext,
...
import {
  useSlotProps
} from "./chunk-IHEKEFFC.js";
import {
  require_react_dom
} from "./chunk-GJ5PGLZ3.js";
import "./chunk-UTIBJGIF.js";
import {
  useTheme
} from "./chunk-MWQG72OC.js";
import {
  shouldForwardProp
} from "./chunk-KIVLWEXE.js";
import "./chunk-JHWSFSAQ.js";
import {
  init_useControlled,
  ...
  useForkRef
} from "./chunk-4WNDEN2H.js";
import {
  styled_default
} from "./chunk-M32MCVCG.js";
import {
  composeClasses,
...
} from "./chunk-CAO3CHAA.js";
import {
  _extends,
  _objectWithoutPropertiesLoose,
  init_extends,
  init_objectWithoutPropertiesLoose
} from "./chunk-6LAHGXDT.js";
import {
  require_prop_types
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold, index) => {
      ...
      return (0, import_jsx_runtime.jsxs)(React6.Fragment, {
...
var ChartContainer = React14.forwardRef(function ChartContainer2(props, ref) {
  ...
  useReducedMotion2();
  return (0, import_jsx_runtime6.jsx)(DrawingProvider, {
    width,
    height,
    margin,
    svgRef,
    children: (0, import_jsx_runtime6.jsx)(SeriesContextProvider, {
      series,
      colors: colors3,
      dataset,
      children: (0, import_jsx_runtime6.jsx)(CartesianContextProvider, {
        xAxis,
        yAxis,
        dataset,
        children: (0, import_jsx_runtime6.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime6.jsx)(HighlightedProvider, {
            highlightedItem,
            onHighlightChange,
            children: (0, import_jsx_runtime6.jsxs)(ChartsSurface, {
              width,
              height,
              ref: handleRef,
              sx,
              ...
              desc,
              disableAxisListener,
              children: [(0, import_jsx_runtime6.jsx)(ChartsAxesGradients, {}), children]
            })
          })
        })
      })
...
var ResponsiveChartContainer = React15.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded2);
  const [containerRef, width, height] = useChartContainerDimensions(inWidth, inHeight);
  return (0, import_jsx_runtime7.jsx)(ResizableContainer, {
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    },
    children: width && height ? (0, import_jsx_runtime7.jsx)(ChartContainer, _extends({}, other, {
      width,
      height,
      ref
    })) : null
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React17.useContext(CartesianContext), _ref = props.axisId ?? xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber,
  ...
  return (0, import_jsx_runtime8.jsxs)(AxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime8.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime8.jsxs)("g", {
        ...
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime8.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
...
function ChartsYAxis(inProps) {
  ...
  const _React$useContext = React18.useContext(CartesianContext), _ref = props.axisId ?? yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime10.jsxs)(React19.Fragment, {
    children: [topId && (0, import_jsx_runtime10.jsx)(ChartsXAxis, _extends({}, topAxisProps, {
      position: "top",
      axisId: topId
    })), bottomId && (0, import_jsx_runtime10.jsx)(ChartsXAxis, _extends({}, bottomAxisProps, {
      position: "bottom",
      axisId: bottomId
    })), leftId && (0, import_jsx_runtime10.jsx)(ChartsYAxis, _extends({}, leftAxisProps, {
      position: "left",
      axisId: leftId
    })), rightId && (0, import_jsx_runtime10.jsx)(ChartsYAxis, _extends({}, rightAxisProps, {
      position: "right",
      axisId: rightId
    }))]
  });
...
function useMouseTracker() {
  const svgRef = React20.useContext(SvgContext);
  const [mousePosition, setMousePosition] = React20.useState(null);
  React20.useEffect(() => {
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React23.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
  const {
    xAxis,
    yAxis,
    xAxisIds,
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types9.default.shape({
    ...
    getColor: import_prop_types9.default.func,
    ...
    series: import_prop_types9.default.object,
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React25.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React25.useMemo(() => {
...
function ChartsTooltip(props) {
  ...
  return (0, import_jsx_runtime15.jsx)(NoSsr, {
...
function DefaultChartsLegend(props) {
  ...
  const labelStyle = React27.useMemo(
  ...
  const padding = React27.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React27.useCallback((label, inStyle = {}) => {
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React27.useMemo(() => {
    let x = 0;
    let y = 0;
  ...
  return (0, import_jsx_runtime16.jsx)(NoSsr, {
    children: (0, import_jsx_runtime16.jsx)(ChartsLegendRoot, {
      className: classes.root,
...
function ChartsLegend(inProps) {
  ...
  const series = React28.useContext(SeriesContext);
  ...
  return (0, import_jsx_runtime17.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime18.jsxs)(React29.Fragment, {
    children: [xAxisHighlight === "band" && axis.x !== null && isBandScale(xScale) && (0, import_jsx_runtime18.jsx)(ChartsAxisHighlightPath, {
    ...
    }), yAxisHighlight === "band" && axis.y !== null && isBandScale(yScale) && (0, import_jsx_runtime18.jsx)(ChartsAxisHighlightPath, {
...
var useInteractionItemProps = (skip) => {
  ...
  const {
    setHighlighted,
    clearHighlighted
  } = React30.useContext(HighlightedContext);
  if (skip) {
    return () => ({});
  }
...
var _excluded6 = ["classes", "color", "cornerRadius", "dataIndex", "endAngle", "id", "innerRadius", "isFaded", "isHighlighted", "onClick", "outerRadius", "paddingAngle", "startAngle", "highlightScope"];
...
function PieArc(props) {
  ...
  return (0, import_jsx_runtime19.jsx)(PieArcRoot, _extends({
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React32.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
var _excluded7 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlighted", "faded", "data", "onItemClick", "skipAnimation"];
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime20.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index) => {
      ...
      return (0, import_jsx_runtime20.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
var _excluded8 = ["id", "classes", "color", "startAngle", "endAngle", "paddingAngle", "arcLabelRadius", "innerRadius", "outerRadius", "cornerRadius", "formattedArcLabel", "isHighlighted", "isFaded", "style"];
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime21.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
...
var _excluded9 = ["arcLabel", "arcLabelMinAngle", "arcLabelRadius", "cornerRadius", "data", "faded", "highlighted", "id", "innerRadius", "outerRadius", "paddingAngle", "skipAnimation", "slotProps", "slots"];
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime22.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime22.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PiePlot(props) {
  ...
  const seriesData = React36.useContext(SeriesContext).pie;
  const {
    left,
    top,
    width,
  ...
  return (0, import_jsx_runtime23.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime23.jsx)("g", {
        ...
        children: (0, import_jsx_runtime23.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime23.jsx)("g", {
        transform: `translate(${left + cx}, ${top + cy})`,
        children: (0, import_jsx_runtime23.jsx)(PieArcLabelPlot, {
          innerRadius,
...
function PieChart(props) {
  ...
  return (0, import_jsx_runtime27.jsxs)(ResponsiveChartContainer, {
    ...
    highlightedItem,
    onHighlightChange,
    children: [(0, import_jsx_runtime27.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime27.jsx)(PiePlot, {
      slots,
      slotProps,
      onItemClick,
      skipAnimation: skipAnimation2
      ...
      slots,
      slotProps
    }), (0, import_jsx_runtime27.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime27.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), !loading && (0, import_jsx_runtime27.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), children]
  });
...
true ? PieChart.propTypes = {
  ...
  xAxis: import_prop_types21.default.arrayOf(import_prop_types21.default.shape({
    ...
    max: import_prop_types21.default.oneOfType([import_prop_types21.default.instanceOf(Date), import_prop_types21.default.number]),
    min: import_prop_types21.default.oneOfType([import_prop_types21.default.instanceOf(Date), import_prop_types21.default.number]),
    position: import_prop_types21.default.oneOf(["bottom", "left", "right", "top"]),
